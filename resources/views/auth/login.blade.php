            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="animate-fade-up delay-3">
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="password"
                               class="block text-xs font-medium text-gray-600 tracking-wide uppercase">
                            Kata Sandi
                        </label>
                    ...
                    <div class="relative">
                        ...
                        <input id="password"
                               class="input-field w-full pl-10 pr-12 py-3 rounded-xl border
                        ...
                        <button type="button"
                            ...
                            <svg id="eye-hide" xmlns="http://www.w3.org/2000/svg"
                                 class="w-[18px] h-[18px] hidden" fill="none"
                                 viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7
                                         ...
                                         3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542
