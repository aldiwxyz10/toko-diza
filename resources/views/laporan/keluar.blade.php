...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="fw-bold mb-0"><i class="bi bi-graph-down-arrow me-2 text-danger"></i>Laporan Barang Keluar</h4>
    ...
    <div class="card-body">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('laporan.keluar') }}" class="btn btn-sm btn-outline-secondary ms-1">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        <div class="card text-center">
            <div class="card-body py-3">
                <h4 class="fw-bold mb-0 text-danger">{{ number_format($totalJumlah) }}</h4>
    ...
    <div class="col-md-6">
        <div class="card text-center">
            <div class="card-body py-3">
                <h4 class="fw-bold mb-0">{{ $barangKeluars->count() }}</h4>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr><th>#</th><th>Tanggal</th><th>Kode</th><th>Nama Barang</th><th>Jenis</th><th class="text-center">Jumlah Keluar</th><th>Keterangan</th></tr>
                </thead>
                <tbody>
                ...
                <tfoot class="table-light fw-bold">
                    <tr>
                        ...
                        <td class="text-center text-danger">-{{ number_format($totalJumlah) }}</td>
                        <td></td>
                    </tr>
                </tfoot>
                @endif
